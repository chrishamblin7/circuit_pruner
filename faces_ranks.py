...
image_root = '/mnt/data/chris/dropbox/Research-Hamblin/Projects/circuit_pruner_cvpr2022/image_data/faces/'
...
for nodeid in nodeids:
	...
	for i, image_name in enumerate(os.listdir(image_root)):
		print(image_name)
	...
	output_folder = '/mnt/data/chris/dropbox/Research-Hamblin/Projects/circuit_pruner_cvpr2022/circuit_ranks/alexnet_sparse/faces_ranks/actxgrad/'
