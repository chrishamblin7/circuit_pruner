# Copyright 2020 The lucent_fresh Authors. All Rights Reserved.
#
...
from lucent_fresh.optvis import objectives, transform, param
from lucent_fresh.misc.io import show
...
def hook_model(model, image_f):
    ...
    def hook(layer):
        if layer == "input":
            ...
            assert layer in features, f"Invalid layer {layer}. Retrieve the list of layers with `lucent_fresh.modelzoo.util.get_model_layers(model)`."
